	...
	public void service(ServletRequest request, ServletResponse response)
        ...
        else
        {
            ...
            if (!continuation.isPending())
            {
                ...
                SoapUIHttpExchange exchange = new SoapUIHttpExchange(httpRequest, httpResponse, capture, capturedData);
