...
rem Default WSI home directory
if not "%WSI_HOME%" == "" goto start
set WSI_HOME=c:\wsi-test-tools

:start
set WSI_JAVA_HOME=%WSI_HOME%\java
                                                
rem Set classpath           
set WSI_CP=%WSI_JAVA_HOME%\lib\wsi-test-tools.jar
rem set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib

rem Xerces
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\xercesImpl.jar
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\xmlParserAPIs.jar

rem WSDL4J
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\wsdl4j.jar

rem UDDI4J
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\uddi4j.jar
   
rem Axis    
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\axis.jar
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\jaxrpc.jar
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\saaj.jar
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\commons-discovery.jar
set WSI_CP=%WSI_CP%;%WSI_JAVA_HOME%\lib\commons-logging.jar

rem Set Java options
set WSI_JAVA_OPTS=%WSI_JAVA_OPTS% -Dorg.xml.sax.driver=org.apache.xerces.parsers.SAXParser
set JAVA=%WSI_HOME%\..\jre\bin\java
