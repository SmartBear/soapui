...
public enum SoapUIActions {
    ...
    //Tools
    USE_JBOSSWS_ARTIFACTS_TOOL("UseJBossWSArtifacts", PROJECTS, NO),
    USE_JBOSSWS_JAXWS_ARTIFACTS_TOOL("UseJBossWSJaxWSArtifacts", PROJECTS, NO),
    USE_JAX_RPC_ARTIFACTS_TOOL("UseJaxRpcArtifacts", PROJECTS, NO),
    USE_JAX_WS_ARTIFACTS_TOOL("UseJaxWsArtifacts", PROJECTS, NO),
    USE_AXIS_1_ARTIFACTS_TOOL("UseAxis1Artifacts", PROJECTS, NO),
    USE_AXIS_2_ARTIFACTS_TOOL("UseAxis2Artifacts", PROJECTS, NO),
    USE_APACHE_CXF_TOOL("UseApacheCxf", PROJECTS, NO),
    USE_XFIRE_1_STUBS_TOOL("UseXFire1Stubs", PROJECTS, NO),
    USE_ORACLE_PROXY_ARTIFACTS_TOOL("UseOracleProxyArtifacts", PROJECTS, NO),
    USE_XML_BEANS_CLASSES_TOOL("UseXmlBeansClasses", PROJECTS, NO),
    USE_JAXB_2_ARTIFACTS_TOOL("UseJaxb2Artifacts", PROJECTS, NO),
    USE_DOT_NET_2_ARTIFACTS_TOOL("UseDotNet2Artifact", PROJECTS, NO),
    USE_GSOAP_ARTIFACTS_TOOL("UseGSoapArtifacts", PROJECTS, NO),
    USE_TCP_MON_TOOL("UseTcpMon", PROJECTS, NO),
    USE_HERMES_JMS_TOOL("UseHermesJMS", PROJECTS, NO),
