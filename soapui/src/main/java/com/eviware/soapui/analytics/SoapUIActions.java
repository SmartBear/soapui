...
public enum SoapUIActions {
    ...
    //Tools
    USE_JBOSSWS_ARTIFACTS_TOOL("ToolsMenuUseJBossWSArtifacts", PROJECTS, MAIN_MENU),
    USE_JBOSSWS_JAXWS_ARTIFACTS_TOOL("ToolsMenuUseJBossWSJaxWSArtifacts", PROJECTS, MAIN_MENU),
    USE_JAX_RPC_ARTIFACTS_TOOL("ToolsMenuUseJaxRpcArtifacts", PROJECTS, MAIN_MENU),
    USE_JAX_WS_ARTIFACTS_TOOL("ToolsMenuUseJaxWsArtifacts", PROJECTS, MAIN_MENU),
    USE_AXIS_1_ARTIFACTS_TOOL("ToolsMenuUseAxis1Artifacts", PROJECTS, MAIN_MENU),
    USE_AXIS_2_ARTIFACTS_TOOL("ToolsMenuUseAxis2Artifacts", PROJECTS, MAIN_MENU),
    USE_APACHE_CXF_TOOL("ToolsMenuUseApacheCxf", PROJECTS, MAIN_MENU),
    USE_XFIRE_1_STUBS_TOOL("ToolsMenuUseXFire1Stubs", PROJECTS, MAIN_MENU),
    USE_ORACLE_PROXY_ARTIFACTS_TOOL("ToolsMenuUseOracleProxyArtifacts", PROJECTS, MAIN_MENU),
    USE_XML_BEANS_CLASSES_TOOL("ToolsMenuUseXmlBeansClasses", PROJECTS, MAIN_MENU),
    USE_JAXB_2_ARTIFACTS_TOOL("ToolsMenuUseJaxb2Artifacts", PROJECTS, MAIN_MENU),
    USE_DOT_NET_2_ARTIFACTS_TOOL("ToolsMenuUseDotNet2Artifact", PROJECTS, MAIN_MENU),
    USE_GSOAP_ARTIFACTS_TOOL("UseGSoapArtifacts", PROJECTS, MAIN_MENU),
    USE_TCP_MON_TOOL("ToolsMenuUseTcpMon", PROJECTS, MAIN_MENU),
    USE_HERMES_JMS_TOOL("ToolsMenuUseHermesJMS", PROJECTS, MAIN_MENU),
    ...
    ASSIGN_WSS_AUTH("AssignWssAuth", PROJECTS, MAIN_EDITOR),
    ...
    IMPORT_PACKED_PROJECT("MainMenuImportPackedProject", null, MAIN_MENU),
    IMPORT_REMOTE_PROJECT("MainMenuImportRemoteProject", null, MAIN_MENU),
    EXPORT_PROJECT("MainMenuExportProject", null, MAIN_MENU),
