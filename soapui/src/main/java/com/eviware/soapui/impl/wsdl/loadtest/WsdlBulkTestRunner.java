...
public class WsdlBulkTestRunner extends AbstractTestRunner<WsdlBulkTest, BulkTestRunContext> {
    ...
    @Override
    protected void internalFinally(BulkTestRunContext context) {

    }

    @Override
    public BulkTestRunContext createContext(StringToObjectMap properties) {
        return null;
    }

    @Override
    protected void internalRun(BulkTestRunContext runContext2) throws Exception {
