...
public interface HelpUrls {
    ...
    */
    ...
    public static final String CHANGEMOCKOPERATION_HELP_URL = "http://www.soapui.org/soap-mocking/working-with-mockservices.html";
    public static final String CHANGEOPERATION_HELP_URL = "http://www.soapui.org/soap-and-wsdl/operations-and-requests.html";
    ...
    public static final String DEBUGGING_TESTCASE_DEBUGGING = "http://www.soapui.org/functional-testing/testcase-debugging.html";
    ...
    public static final String FUNCTIONAL_TESTING_SETUP_SCRIPT = "http://www.soapui.org/functional-testing/working-with-scripts.html";
    public static final String FUNCTIONAL_TESTING_TEARDOWN_SCRIPT = "http://www.soapui.org/functional-testing/working-with-scripts.html";

    public static final String GENERATE_MOCKSERVICE_HELP_URL = "http://www.soapui.org/Service-Mocking/mocking-soap-services.html ";
    public static final String GENERATE_REST_MOCKSERVICE = "http://www.soapui.org/rest-testing-mocking/rest-mock-service-creation/rest-mock-from-service.html";
    ...
    public static final String GROOVYASSERTION_HELP_URL = "http://www.soapui.org/functional-testing/validating-messages/using-script-assertions.html";
    ...
    public static final String LOADTESTEDITOR_HELP_URL = "http://www.soapui.org/load-testing/getting-started.html";
    public static final String LOADTESTOPTIONS_HELP_URL = "http://www.soapui.org/load-testing/reference/navigation.html";
    public static final String LOADTEST_ASSERTIONS_URL = "http://www.soapui.org/Load-Testing/validating-performance.html";

    public static final String MANUALTESTSTEP_HELP_URL = "http://www.soapui.org/functional-testing/teststep-reference/manual-teststep.html";
    public static final String MAX_ERRORS_LOAD_TEST_ASSERTION_HELP_URL = "http://www.soapui.org/load-testing/reference/assertion.html";
    ...
    public static final String MOCKOPERATION_QUERYMATCHDISPATCH_HELP_URL = "http://www.soapui.org/soap-mocking/working-with-mockservices.html";
    public static final String MOCKOPERATION_SCRIPTDISPATCH_HELP_URL = "http://www.soapui.org/soap-mocking/working-with-mockservices.html";
    public static final String MOCKOPERATION_XPATHDISPATCH_HELP_URL = "http://www.soapui.org/soap-mocking/working-with-mockservices.html";
    public static final String MOCKRESPONSE_SCRIPT_HELP_URL = "http://www.soapui.org/soap-mocking/mockoperations-and-responses.html";
    public static final String MOCKSERVICEOPTIONS_HELP_URL = "http://www.soapui.org/soap-mocking/working-with-mockservices.html";
    ...
    public static final String ORACLEWSA_HELP_URL = "http://www.soapui.org/soap-and-wsdl/soap-code-generation.html";
    public static final String OUTGOINGWSS_HELP_URL = "http://www.soapui.org/soapui-projects/ws-security.html";

    public static final String PREFERENCES_HELP_URL = "http://www.soapui.org/Working-with-soapUI/preferences.html";
    public static final String PREPAREDPROPERTIES_HELP_URL = "http://www.soapui.org/soapui-projects/jdbc-connections.html";
    ...
    public static final String PROPERTIESSTEPEDITOR_HELP_URL = "http://www.soapui.org/functional-testing/properties/working-with-properties.html";
    ...
    public static final String REQUESTEDITOR_HELP_URL = "http://www.soapui.org/soap-and-wsdl/working-with-messages.html";
    ...
    public static final String REST_MOCK_RESPONSE_EDITOR_BODY = "http://www.soapui.org/rest-testing-mocking/reference/mock-response-editor.html";
    public static final String REST_MOCK_RESPONSE_EDITOR_HEADER = "http://www.soapui.org/rest-testing-mocking/reference/mock-response-editor.html";
    public static final String REST_MOCK_RESPONSE_SCRIPT = "http://www.soapui.org/rest-testing-mocking/reference/mock-response-editor.html";
    public static final String REST_MOCK_SCRIPTDISPATCH = "http://www.soapui.org/rest-testing-mocking/reference/mock-response-editor.html";
    ...
    public static final String SECURITY_ASSERTION_HELP = "http://www.soapui.org/security-testing/overview-of-security-scans.html";
    public static final String SECURITY_INVALID_HTTP_CODES_ASSERTION_HELP = "http://www.soapui.org/security-testing/overview-of-security-scans.html";
    ...
    public static final String SECURITY_SENSITIVE_INFORMATION_EXPOSURE_ASSERTION_HELP = "http://www.soapui.org/security-testing/overview-of-security-scans.html";
    public static final String SECURITY_VALID_HTTP_CODES_ASSERTION_HELP = "http://www.soapui.org/security-testing/overview-of-security-scans.html";
    public static final String SECURITY_XSS_ASSERTION_HELP = "http://www.soapui.org/Security/cross-site-scripting.html";
    public static final String SETMOCKOPERATION_HELP_URL = "http://www.soapui.org/soap-mocking/reference/mockresponse.html";
    public static final String SIMPLE_CONTAINS_HELP_URL = "http://www.soapui.org/functional-testing/validating-messages/getting-started-with-assertions.html";
    public static final String SIMPLE_NOT_CONTAINS_HELP_URL = "http://www.soapui.org/functional-testing/validating-messages/getting-started-with-assertions.html";
    ...
    public static final String SOAPMONITOR_MONITOR_OPTIONS = "http://www.soapui.org/http-recording/reference/general-options.html";
    public static final String STATISTICSGRAPH_HELP_URL = "http://www.soapui.org/load-testing/reference/loadtest-graph.html";
    public static final String STEP_AVERAGE_LOAD_TEST_ASSERTION_HELP_URL = "http://www.soapui.org/load-testing/reference/assertion.html";
    public static final String STEP_MAXIMUM_LOAD_TEST_ASSERTION_HELP_URL = "http://www.soapui.org/load-testing/reference/assertion.html";
    public static final String STEP_STATUS_LOAD_TEST_ASSERTION_HELP_URL = "http://www.soapui.org/load-testing/reference/assertion.html";
    ...
    public static final String STAY_TUNED = "http://www.soapui.org/getting-started/help-in-soapui/stay-tuned.html";
    ...
    public static final String TESTSUITEEDITOR_HELP_URL = "http://www.soapui.org/functional-testing/reference/testsuite-reference.html";
    ...
    public static final String XPATHASSERTIONEDITOR_HELP_URL = "http://www.soapui.org/functional-testing/validating-messages/validating-xml-messages.html";
