...
public interface HelpUrls {
    ...
    public static final String BASE_URL_DEV = "http://www.soapui.stage/";
    ...
    public static final String ADD_ASSERTION_PANEL = "Assertions/assertion-editor.html";
    ...
    public static final String CHANGEMOCKOPERATION_HELP_URL = "Service-Mocking/mock-operation-editor.html";
    ...
    public static final String CLONETESTCASE_HELP_URL = "Functional-Testing/testsuite-editor.html";
    public static final String CLONETESTSTEP_HELP_URL = "Functional-Testing/testcase-editor.html";
    ...
    public static final String DEBUGGING_TESTCASE_DEBUGGING = "Debugging/testcase-debugging.html";

    public static final String ENDPOINTSEDITOR_HELP_URL = "SOAP-and-WSDL/working-with-wsdls.html";
    public static final String FUNCTIONAL_TESTING_SETUP_SCRIPT = "Functional-Testing/setup-script.html";
    public static final String FUNCTIONAL_TESTING_TEARDOWN_SCRIPT = "Functional-Testing/teardown-script.html";

    public static final String GENERATE_MOCKSERVICE_HELP_URL = "Service-Mocking/mocking-soap-services.html ";
    public static final String GENERATE_REST_MOCKSERVICE = "REST-Service-Mocking/generate-rest-mock.html";
    ...
    public static final String GROOVYASSERTION_HELP_URL = "Assertions/script-assertion.html";
    public static final String GROOVYSTEPEDITOR_HELP_URL = "functional-testing/working-with-scripts.html";

    public static final String HEADERS_HELP_URL = "SOAP-and-WSDL/custom-http-headers.html";

    public static final String INCOMINGWSS_HELP_URL = "Working-with-Projects/ws-security.html";
    ...
    public static final String LOADTESTEDITOR_HELP_URL = "Load-Testing/load-test-editor.html";
    public static final String LOADTESTOPTIONS_HELP_URL = "Load-Testing/load-test-options.html";
    public static final String LOADTEST_ASSERTIONS_URL = "Load-Testing/validating-performance.html";

    public static final String MANUALTESTSTEP_HELP_URL = "functional-testing/manual-teststep.html";
    public static final String MAX_ERRORS_LOAD_TEST_ASSERTION_HELP_URL = "Load-Testing/max-errors-assertion.html";
    ...
    public static final String MOCKOPERATION_QUERYMATCHDISPATCH_HELP_URL = "Service-Mocking/mock-operation-editor.html";
    public static final String MOCKOPERATION_SCRIPTDISPATCH_HELP_URL = "Service-Mocking/mock-operation-editor.html";
    public static final String MOCKOPERATION_XPATHDISPATCH_HELP_URL = "Service-Mocking/mock-operation-editor.html";
    public static final String MOCKRESPONSE_SCRIPT_HELP_URL = "Service-Mocking/mock-response-editor.html";
    public static final String MOCKSERVICEOPTIONS_HELP_URL = "Service-Mocking/mock-service-editor.html";
    ...
    public static final String ORACLEWSA_HELP_URL = "Code-Generation/oracle-wsa.html";
    public static final String OUTGOINGWSS_HELP_URL = "Working-with-Projects/ws-security.html";

    public static final String PREFERENCES_HELP_URL = "Working-with-soapUI/preferences.html";
    public static final String PREPAREDPROPERTIES_HELP_URL = "Functional-Testing/datasource-jdbc.html";
    public static final String PROJECT_OVERVIEW_HELP_URL = "Working-with-Projects/working-with-soapui-projects.html";
    public static final String PROPERTIESSTEPEDITOR_HELP_URL = "Functional-Testing/properties-teststep.html";
    ...
    public static final String REST_MOCK_RESPONSE_EDITOR_BODY = "REST-Service-Mocking/mock-response-editor-body.html";
    public static final String REST_MOCK_RESPONSE_EDITOR_HEADER = "REST-Service-Mocking/mock-response-editor-header.html";
    public static final String REST_MOCK_RESPONSE_SCRIPT = "REST-Service-Mocking/mock-response-script.html";
    public static final String REST_MOCK_SCRIPTDISPATCH = "REST-Service-Mocking/mock-service-dispatch.html";
    ...
    public static final String SECURITY_ASSERTION_HELP = "Assertions/security-scan-assertion.html";
    public static final String SECURITY_INVALID_HTTP_CODES_ASSERTION_HELP = "Security/invalid-http-code.html";
    ...
    public static final String SECURITY_SENSITIVE_INFORMATION_EXPOSURE_ASSERTION_HELP = "Security/system-information-exposure.html";
    public static final String SECURITY_VALID_HTTP_CODES_ASSERTION_HELP = "Security/valid-http-codes.html";
    public static final String SECURITY_XSS_ASSERTION_HELP = "Security/cross-site-scripting.html";
    public static final String SETMOCKOPERATION_HELP_URL = "Functional-Testing/mockresponse-teststep.html";
    public static final String SIMPLE_CONTAINS_HELP_URL = "Assertions/contains-assertion.html";
    public static final String SIMPLE_NOT_CONTAINS_HELP_URL = "Assertions/not-contains-assertion.html";
    ...
    public static final String SOAPMONITOR_MONITOR_OPTIONS = "HTTP-Recording/monitor-options.html";
    public static final String STATISTICSGRAPH_HELP_URL = "Load-Testing/statistics-diagram.html";
    public static final String STEP_AVERAGE_LOAD_TEST_ASSERTION_HELP_URL = "Load-Testing/step-average-assertion.html";
    public static final String STEP_MAXIMUM_LOAD_TEST_ASSERTION_HELP_URL = "Load-Testing/step-maximum-assertion.html";
    public static final String STEP_STATUS_LOAD_TEST_ASSERTION_HELP_URL = "Load-Testing/step-status-assertion.html";
    public static final String STEP_TPS_LOAD_TEST_ASSERTION_HELP_URL = "Load-Testing/step-tps-assertion.html";

    public static final String TESTCASEEDITOR_HELP_URL = "Functional-Testing/testcase-editor.html";
    public static final String TESTCASEOPTIONS_HELP_URL = "Functional-Testing/testcase-options.html";
    ...
    public static final String TESTSUITEEDITOR_HELP_URL = "Functional-Testing/testsuite-editor.html";
    ...
    public static final String UPDATE_INTERFACE_HELP_URL = "SOAP-and-WSDL/update-definition.html";
    public static final String USERGUIDE_HELP_URL = "getting-started/help-in-soapui/help-in-soapui.html";

    public static final String WADL_PARAMS_HELP_URL = "REST-Testing/understanding-rest-parameters.html";
    ...
    public static final String XPATHASSERTIONEDITOR_HELP_URL = "Assertions/xpath-match-assertion.html";
    public static final String XQUERYASSERTIONEDITOR_HELP_URL = "Assertions/xquery-match-assertion.html";
    ...
    */
    ...
    // Apache
    public static final String AXIS1X_HELP_URL = "https://axis.apache.org/axis/java/index.html";
    public static final String AXIS2X_HELP_URL = "https://axis.apache.org/axis2/java/core/index.html";
    ...
    // Java
    public static final String JABXJC_HELP_URL = "https://java.net/projects/jax-rpc/";
    public static final String JBOSSWS_WSCONSUME_HELP_URL = "https://docs.jboss.org/author/display/JBWS/wsconsume";
    public static final String WADL2JAVA_HELP_URL = "https://wadl.java.net/wadl2java.html";
    public static final String WSCOMPILE_HELP_URL = "https://docs.oracle.com/javame/dev-tools/jme-sdk-3.0-mac/UserGuide-html/z400007747424.html";
    public static final String WSIMPORT_HELP_URL = "https://docs.oracle.com/javase/6/docs/technotes/tools/share/wsimport.html";

    // Jboss
    public static final String WSTOOLS_HELP_URL = "https://developer.jboss.org/wiki/JBossWS-JAX-WSTools";
