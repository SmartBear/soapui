...
public class ExtendedLockMethod extends HttpLockMethod implements ExtendedEntityEnclosingHttpMethod {
    private final HttpMethodSupport httpMethodSupport;

    public ExtendedLockMethod() {
        httpMethodSupport = new HttpMethodSupport();
    }

    public ExtendedLockMethod(String url) {
        super(url);
        httpMethodSupport = new HttpMethodSupport();
    }
