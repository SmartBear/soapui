...
public class DataSourceLoopTestStepPanelBuilder extends DesktopPanelFactory<DataSourceLoopTestStep> {
    @Override
    public DesktopPanel buildDesktopPanel(DataSourceLoopTestStep testStep) {
        return new DataSourceLoopTestStepPanel(testStep);
    }

    @Override
    public Class<DataSourceLoopTestStep> getTargetModelItem() {
        return DataSourceLoopTestStep.class;
    }
}
