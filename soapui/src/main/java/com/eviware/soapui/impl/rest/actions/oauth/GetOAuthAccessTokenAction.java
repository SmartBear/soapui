...
public class GetOAuthAccessTokenAction extends AbstractAction
{
	...
	public GetOAuthAccessTokenAction( OAuth2Profile target )
	{
		...
		putValue( Action.SHORT_DESCRIPTION, "Gets an OAuth 2.0 access token and stores it in this profile" );
	}
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		{
			SoapUI.logError( e, "Error retrieving OAuth 2.0 access token" );
