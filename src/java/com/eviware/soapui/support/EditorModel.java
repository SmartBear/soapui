...
public interface EditorModel
{
   ...
   {
      /**
       * Notification that should be sent by EditorModel to all registered listeners if the text changes by some
       * external method (ie not via EditorModel.setEditorText() )
       *
