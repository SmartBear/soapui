...
public class RequestToTestStepsDropHandler extends AbstractAfterModelItemDropHandler<WsdlRequest, WsdlTestStepsModelItem>
{
	...
	private boolean addRequestToTestCase( WsdlRequest source, WsdlTestStepsModelItem target )
	{
		if( !UISupport.confirm( "Add Request [" + source.getName() + "] to TestCase [" + 
					target.getTestCase().getName() +"]", "Add Request to TestCase" ))
			return false;
