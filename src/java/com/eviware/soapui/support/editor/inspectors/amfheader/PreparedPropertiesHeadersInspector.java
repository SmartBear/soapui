...
public class PreparedPropertiesHeadersInspector extends AbstractXmlInspector implements PropertyChangeListener
{
	...
	private final PreparedPropertiesHeadersInspectorModel model;
	private JTable headersTable;
	private JPanel panel;
	private JButton removeButton;
	public boolean changing;

	protected PreparedPropertiesHeadersInspector( PreparedPropertiesHeadersInspectorModel model )
	{
		super( "Prepared Properties (" + ( model.getHeaders() == null ? "0" : model.getHeaders().size() ) + ")",
				"Prepared Properties amf message", true, PreparedPropertiesHeadersInspectorFactory.INSPECTOR_ID );
		this.model = model;
	...
	public JComponent getComponent()
	{
		...
		headersTableModel = new StringToStringMapTableModel( model.getHeaders(), "PreparedProperties", "Value", !model
				.isReadOnly() );
		headersTableModel.addTableModelListener( new TableModelListener()
		{
			public void tableChanged( TableModelEvent arg0 )
			{
				...
				setTitle( "Prepared Properties (" + ( model.getHeaders() == null ? "0" : model.getHeaders().size() ) + ")" );
			}
		} );
	...
	private final class RemoveAction extends AbstractAction
	{
		private RemoveAction()
		{
			...
			putValue( AbstractAction.SHORT_DESCRIPTION, "Removes the selected Prepared Properties from this message" );
		}
	...
	private final class AddAction extends AbstractAction
	{
		private AddAction()
		{
			...
			putValue( AbstractAction.SHORT_DESCRIPTION, "Adds a custom Prepared Property to this message" );
		}
