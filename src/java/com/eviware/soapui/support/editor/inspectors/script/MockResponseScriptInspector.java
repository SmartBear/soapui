...
public class MockResponseScriptInspector extends AbstractXmlInspector
{
	...
	protected void buildResponseScriptEditor()
	{
		...
		panel.add( new JScrollPane( responseScriptEditor ), BorderLayout.CENTER );
	}
	...
	private JComponent buildScriptToolbar()
	{
		...
		toolBar.addFixed( UISupport.createActionButton( new ShowOnlineHelpAction( HelpUrls.MOCKRESPONSE_SCRIPT_HELP_URL ), true ));
	...
	private class RunScriptAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				mockResponse.evaluateScript( mockResponse.getMockResult() == null ? null :
					mockResponse.getMockResult().getMockRequest() );
