...
public interface PreparedPropertiesHeadersInspectorModel
{
	...
	public static abstract class AbstractPreparedHeadersModel<T extends ModelItem> implements PreparedPropertiesHeadersInspectorModel,
			PropertyChangeListener
	{
		...
		protected AbstractPreparedHeadersModel(boolean readOnly, T modelItem, String propertyName)
		{
