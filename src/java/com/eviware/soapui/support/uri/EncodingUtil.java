...
public class EncodingUtil
{
	 ...
	 * breaks, as in multi-line text field values, are represented as CR LF
	 * pairs, i.e. `%0D%0A'.
	 * 
	 * <p>
	 ...
	 * @since 2.0 final
	 */
	public static String formUrlEncode( NameValuePair[] pairs, String charset ) throws Exception
	{
		try
		{
		...
		catch( UnsupportedEncodingException e )
		{
			...
			catch( UnsupportedEncodingException fatal )
			{
				...
				throw new Exception( "Encoding not supported: " + DEFAULT_CHARSET );
			}
		}
	}
	 ...
	 * @since 3.0
	 */
	public static byte[] getAsciiBytes( final String data ) throws URIException
	{
	...
	/**
	 * Converts the byte array of ASCII characters to a string. This method is to
	 * be used when decoding content of HTTP elements (such as response headers)
	 * 
	 * @param data
	 *           the byte array to be encoded
	 * @param offset
	 ...
	 * @since 3.0
	 */
	public static String getAsciiString( final byte[] data, int offset, int length ) throws URIException
	{
	 ...
	 * @since 3.0
	 */
	public static String getAsciiString( final byte[] data ) throws URIException
	{
