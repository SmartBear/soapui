...
public class FormatXmlJEditAction extends AbstractAction
{
	private final static Logger log = Logger.getLogger( FormatXmlAction.class );
	private final JXEditTextArea textArea;

	public FormatXmlJEditAction( JXEditTextArea editArea )
	{
		this( editArea, "Format XML" );
	}

	public FormatXmlJEditAction( JXEditTextArea editArea, String title )
	{
		super( title );
