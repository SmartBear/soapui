...
public class ProjectTreeNode extends AbstractModelItemTreeNode<Project>
{
   ...
   public int getIndexOfChild(Object child)
   {
   	...
   	if( index >= 0 ) return index + propMod;
   	
   	index = testSuiteNodes.indexOf( child );
   	if( index >= 0 ) return index + interfaceNodes.size() + propMod;
   	
   	index = mockServiceNodes.indexOf( child );
   	if( index >= 0 ) return index + interfaceNodes.size() + testSuiteNodes.size() + propMod;
	...
	private class InternalProjectListener extends ProjectListenerAdapter
   {
      ...
      public void interfaceRemoved(Interface iface)
      {
      	...
      	else throw new RuntimeException( "Removing unkown interface" );
      }
      ...
      public void testSuiteRemoved(TestSuite testSuite)
      {
      	...
      	else throw new RuntimeException( "Removing unkown testSuite" );
      }
		...
		public void mockServiceRemoved( MockService mockService )
		{
      	...
      	else throw new RuntimeException( "Removing unkown mockService" );
		}
