   ...
   public class TestStepsTreeNode extends AbstractTreeNode<WsdlTestStepsModelItem>
	{
   	private List<TestStepTreeNode> testStepNodes = new ArrayList<TestStepTreeNode>();
		...
		public void testStepRemoved(TestStep testStep, int index)
		{
      	...
      	else throw new RuntimeException( "Removing unkown testStep" );
		}
	...
	public class LoadTestsTreeNode extends AbstractTreeNode<WsdlLoadTestsModelItem>
	{
		...
		protected LoadTestsTreeNode()
		{
			...
			{
				loadTestNodes.add( new LoadTestTreeNode( getTestCase().getLoadTestAt( c ), 
						getModelItem(), getTreeModel() ));
			}
		...
		{
			LoadTestTreeNode loadTestTreeNode = new LoadTestTreeNode( loadTest, 
					getModelItem(), getTreeModel() );
		...
		public void loadTestRemoved(LoadTest loadTest)
		{
      	...
      	else throw new RuntimeException( "Removing unkown loadTest" );
      }
