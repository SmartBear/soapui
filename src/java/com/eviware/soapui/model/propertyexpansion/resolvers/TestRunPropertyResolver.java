...
//			String value = ResolverUtils.checkForExplicitReference( propertyName, PropertyExpansion.PROJECT_REFERENCE, testSuite.getProject(), trc, globalOverride );
//			if( value != null )
//				return value;
//			
//			value = ResolverUtils.checkForExplicitReference( propertyName, PropertyExpansion.TESTSUITE_REFERENCE, testSuite, trc, globalOverride );
//			if( value != null )
//				return value;
//			
//			value = ResolverUtils.checkForExplicitReference( propertyName, PropertyExpansion.TESTCASE_REFERENCE, testCase, trc, globalOverride );
//			if( value != null )
//				return value;
//		}
//		
...
//				if( property != null )
//				{
//					property = ResolverUtils.extractXPathPropertyValue( property, PropertyExpansionUtils.expandProperties( trc, xpath ) );
//				}
//			}
//			else
//			{
