...
public interface TestRunner 
{
	...
	/**
	 * Starts running this TestRunners TestCase. If the async flag is set to true, this method will return
	 * directly, otherwise it will block until the TestCase is finished
	 * 
	 * @param async flag controlling if TestCase should be run in seperate or callers thread.
	 */
