...
{
	@Setting( name="Cache WSDLs", description="caches and associated WSDLs locally for offline access and improved performance", 
	...
	public final static String XML_GENERATION_TYPE_EXAMPLE_VALUE = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-type-example-value";
	
	@Setting( name="Type Comment", description="generate comments with type information in new requests", type=SettingType.BOOLEAN )
	public final static String XML_GENERATION_TYPE_COMMENT_TYPE = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-type-comment-type";
	...
	public final static String XML_GENERATION_ALWAYS_INCLUDE_OPTIONAL_ELEMENTS = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-always-include-optional-elements";
	
	@Setting( name="Pretty Print", description="pretty print response messages", type=SettingType.BOOLEAN )
	public final static String PRETTY_PRINT_RESPONSE_MESSAGES = WsdlSettings.class.getSimpleName() + "@" + "pretty-print-response-xml";
	...
	public final static String ALLOW_INCORRECT_CONTENTTYPE = WsdlSettings.class.getSimpleName() + "@" + "allow-incorrect-contenttype";
	...
	public final static String PRETTY_PRINT_PROJECT_FILES = WsdlSettings.class.getSimpleName() + "@" + "pretty-print-project-files";

	public static final String XML_GENERATION_SKIP_COMMENTS = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-skip-comments";
	
	
//	@Setting( name="Always Attachments", description="always allow attachments despite of definition", type=SettingType.BOOLEAN )
//	public final static String ALWAYS_ALLOW_ATTACHMENTS = WsdlSettings.class.getSimpleName() + "@" + "always-allow-attachments";
