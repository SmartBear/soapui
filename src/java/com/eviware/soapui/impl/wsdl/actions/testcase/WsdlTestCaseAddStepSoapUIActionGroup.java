...
/**
 * SoapUIActionGroup for WsdlTestCases, dynamically creates "Append Step" submenu contents from 
 * the WsdlTestStepRegistry
 * 
 * @author ole.matzura
 */
...
public class WsdlTestCaseAddStepSoapUIActionGroup extends DefaultSoapUIActionGroup<WsdlTestCase>
{
	...
	public SoapUIActionMappingList<WsdlTestCase> getActionMappings( WsdlTestCase modelItem )
	{
		...
		for (int c = 0; c < factories.length; c++)
		{
			...
			{
				DefaultActionMapping<WsdlTestCase> actionMapping = new DefaultActionMapping<WsdlTestCase>( AddWsdlTestStepAction.SOAPUI_ACTION_ID, null,
											factory.getTestStepIconPath(), false, factory );
