	...
	public WSCompileAction()
   {
	...
	protected XFormDialog buildDialog(Interface modelItem)
	{
      ...
      buildArgsForm( builder, false, "wscompile");
		...
		actions.addAction( new WSCompileShowConfigFileAction( "JAX-RPC wscompile", "Contents of generated config.xml file", modelItem ));
		
		return builder.buildDialog( actions,
      		"Specify arguments for JAX-RPC wscompile", UISupport.TOOL_ICON );
	}
