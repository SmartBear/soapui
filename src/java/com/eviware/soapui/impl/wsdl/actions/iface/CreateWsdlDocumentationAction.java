...
public class CreateWsdlDocumentationAction extends AbstractSoapUIAction<WsdlInterface>
{
	...
	protected static void initTransformers() throws Exception
	{
		...
		Transformer transformer = xformFactory.newTransformer( new StreamSource( 
				SoapUI.class.getResourceAsStream( "/com/eviware/soapui/resources/doc/wsdl-viewer.xsl" )
	...
	@AForm(description = "Creates an HTML-Report for the interface WSDL", name = "Create Documentation",
