...
public abstract class AbstractAddToTestCaseAction<T extends ModelItem> extends AbstractSoapUIAction<T>
{
   ...
   {
   	 String testSuiteName = UISupport.prompt( "Missing TestSuite in project, enter name to create", "Create TestSuite", 
       		"TestSuite " + (project.getTestSuiteCount()+1) );
       if( testSuiteName == null ) return null;
       
       String testCaseName = UISupport.prompt( "Enter name for TestCase create", "Create TestCase",
       		"TestCase 1" );
