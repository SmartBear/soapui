...
public class PropertiesStepDesktopPanel extends ModelItemDesktopPanel<WsdlPropertiesTestStep> implements PropertyChangeListener
{
	...
	/*
	public class PropertiesTransferHandler extends AbstractPropertiesTransferHandler
	{
		public PropertiesTransferHandler(JComponent component)
		{
			super(component);
		}

		protected StepProperty getSelectedProperty(JComponent c)
		{
