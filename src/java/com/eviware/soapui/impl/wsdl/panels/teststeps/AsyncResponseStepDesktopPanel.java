...
public class AsyncResponseStepDesktopPanel 
	extends AbstractWsdlMockResponseDesktopPanel<WsdlAsyncResponseTestStep, WsdlMockResponse>
{
    ...
    public class InternalTestRunListener extends TestRunListenerAdapter
    {
        ...
        public void beforeStep(TestRunner testRunner, TestRunContext testRunContext)
        {
            ...
            {
            	WsdlAsyncResponseTestStep step = 
            		getModelItem();
        ...
        public void afterStep(TestRunner testRunner, 
        		TestRunContext testRunContext, TestStepResult result)
        {
    ...
    protected void createToolbar(JXToolBar toolbar)
    {
    	...
    	// TODO Ericsson: Need more space for Path and Value fields. Move them to a dialog?
    ...
    public boolean dependsOn(ModelItem modelItem)
    {
        ...
        return modelItem == getModelItem() || 
        	modelItem == step.getTestCase() || 
        	modelItem == step.getOperation() || 
        	modelItem == step.getOperation().getInterface() || 
        	modelItem == step.getTestCase().getTestSuite() || 
