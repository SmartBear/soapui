...
public class PropertiesStepPanelBuilder extends EmptyPanelBuilder<WsdlPropertiesTestStep>
{
   ...
   public JPanel buildOverviewPanel(WsdlPropertiesTestStep testStep)
   {
   	...
   	table.addProperty( "Create Missing on Load", "createMissingOnLoad", 
   			JPropertiesTable.BOOLEAN_OPTIONS );
   	table.addProperty( "Save before Load", "saveFirst", 
	   			JPropertiesTable.BOOLEAN_OPTIONS );
   	table.addProperty( "Discard Values on Save", "discardValuesOnSave", 
	   			JPropertiesTable.BOOLEAN_OPTIONS );
