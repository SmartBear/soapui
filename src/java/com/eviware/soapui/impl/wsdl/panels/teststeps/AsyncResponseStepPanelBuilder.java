 ...
 */
public class AsyncResponseStepPanelBuilder 
	extends EmptyPanelBuilder<WsdlAsyncResponseTestStep>
{
	...
	{
		JPropertiesTable<WsdlAsyncResponseTestStep> table = 
			new JPropertiesTable<WsdlAsyncResponseTestStep>("AsyncResponse Properties");
		
        StringList stringlist = new StringList(modelItem.getTestCase().getTestSuite().getProject().getWssContainer().getOutgoingWssNames());
        stringlist.add("");
