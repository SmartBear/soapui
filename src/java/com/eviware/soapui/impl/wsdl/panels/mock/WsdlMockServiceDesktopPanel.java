   ...
   private JComponent buildContent()
   {
	...
	protected void addTabs( JTabbedPane tabs, JInspectorPanel inspectorPanel )
	{
		inspectorPanel.addInspector(  new JFocusableComponentInspector<JPanel>( buildDescriptionPanel(), 
					descriptionArea, "Description", "A description for this MockService", true ) );
		...
		operationList.addMouseListener( new ModelItemListMouseListener() 
		{
			...
			protected ActionList getDefaultActions()
			{
				if( defaultActions == null )
				{
					...
					defaultActions.addAction( SwingActionDelegate.createDelegate( AddNewMockOperationAction.SOAPUI_ACTION_ID, getModelItem(), null, 
								null	) );
				}
	...
	private JComponent buildMockOperationListToolbar()
	{
		...
		toolbar.add( UISupport.createToolbarButton( 
					SwingActionDelegate.createDelegate( AddNewMockOperationAction.SOAPUI_ACTION_ID, getModelItem(), 
								null, "/mockOperation.gif" )));
	...
	protected JXToolBar buildToolbar()
	{
		...
		optionsButton = createActionButton( SwingActionDelegate.createDelegate( 
					new MockServiceOptionsAction(), getModelItem(), null, "/options.gif" ), true );
