	...
	implements PropertyChangeListener
{
	...
	public RestTestRequestDesktopPanel(RestTestRequestStep requestStep)
	{
		...
		requestStep.getTestRequest().addPropertyChangeListener(RestTestRequest.STATUS_PROPERTY, this);
	...
	public boolean onClose(boolean canCancel)
	{
		if (super.onClose(canCancel))
		{
			...
			logArea.release();
			getModelItem().getTestRequest().removePropertyChangeListener(RestTestRequest.STATUS_PROPERTY, this);
