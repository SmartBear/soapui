...
//	private WssEntriesListModel entriesModel;
	...
	private JPanel buildIncomingConfigurationsTab()
	{
		...
		incomingWssTable = new JXTable( new IncomingWssTableModel() );
		incomingWssTable.setSortable( false );
...
//		JSplitPane split = UISupport.createHorizontalSplit( buildOutgoingEntryList(), buildOutgoingEntryConfigPanel() );
...
//				setSelectedEntry( index == -1 ? null : ( ( WssEntry ) entriesModel.getElementAt( index ) ) );
//			}
//		} );
//		
		...
		entriesTabs.addChangeListener( new ChangeListener() {
			...
			{
				selectedEntry = entriesTabs.getSelectedIndex() == -1 ? null : 
					selectedOutgoing.getEntries().get( entriesTabs.getSelectedIndex() );
...
//		if( entry != null )
//		{
//			entriesConfigPanel.add( selectedEntry.getConfigurationPanel(), BorderLayout.CENTER );
//		}
//
...
//	}
	...
	private Component buildOutgoingEntriesToolbar()
	{
		...
		toolbar.addFixed( removeOutgoingEntryButton = UISupport.createToolbarButton( new RemoveOutgoingEntryAction(), false ) );
	...
	private JPanel buildCryptosTable()
	{
		...
		cryptosTable = new JXTable( new CryptosTableModel() );
		cryptosTable.setSortable( false );
...
//		cryptosTable.getColumn( 5 ).setCellEditor( new DefaultCellEditor( comboBox ) );
	...
	{
		JXToolBar toolbar = UISupport.createSmallToolbar();
//		toolbar.addFixed( UISupport.createToolbarButton( new ImportWssSettingsAction() ));
		toolbar.addGlue();
	...
	public class CryptosTableModel extends AbstractTableModel 
	{
		...
		public void setValueAt( Object aValue, int rowIndex, int columnIndex )
		{
			...
			{
			case 2:
				crypto.setPassword( aValue.toString() ); break;
			case 3:
				crypto.setDefaultAlias( aValue.toString() ); break;
			case 4:
				crypto.setAliasPassword( aValue.toString() ); break;
			case 5:
				crypto.setCryptoProvider( aValue.toString() ); break;
			}
		}
	...
	public class IncomingWssTableModel extends AbstractTableModel 
	{
		...
		public void setValueAt( Object aValue, int rowIndex, int columnIndex )
		{
			...
			{
			case 1:
				incoming.setDecryptCrypto( aValue == null ? null : aValue.toString() ); break;
			case 2:
				incoming.setSignatureCrypto( aValue == null ? null : aValue.toString() ); break;
			case 3:
				incoming.setDecryptPassword( aValue == null ? null : aValue.toString() ); break;
			}
		}
	...
	public class OutgoingWssTableModel extends AbstractTableModel
	{
		...
		public void setValueAt( Object aValue, int rowIndex, int columnIndex )
		{
			...
			{
			case 1:
				outgoing.setUsername( aValue == null ? null : aValue.toString() ); break;
			case 2:
				outgoing.setPassword( aValue == null ? null : aValue.toString() ); break;
			case 3:
				outgoing.setActor(aValue == null ? null : aValue.toString() ); break;
			case 4: 
				outgoing.setMustUnderstand(aValue == null ? false : (Boolean)aValue ); break;
			}
		}
