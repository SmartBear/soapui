...
public class AssertionsPanel extends JPanel
{
	...
	public AssertionsPanel( Assertable assertable )
	{
      ...
      assertionListPopup.addPopupMenuListener( new PopupMenuListener(){
         ...
         public void popupMenuWillBecomeVisible(PopupMenuEvent e)
         {
            ...
            ActionSupport.addActions( 
            			ActionListBuilder.buildActions( assertion ), assertionListPopup );
         }
   ...
   private class AssertionListModel extends AbstractListModel implements PropertyChangeListener, 
       AssertionsListener
   {
