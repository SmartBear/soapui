...
public class AMFConnection
{
     ...
     * this connection.
     */
    protected PostMethod urlConnection;
    ...
    public void close()
    {
        ...
        {
            urlConnection.releaseConnection();
            urlConnection = null;
        }
        url = null;
        urlObject = null;
    ...
    protected HttpResponseInfo generateHttpResponseInfo()
    {
        ...
        try
        {
            int responseCode = urlConnection.getStatusCode();
            String responseMessage = urlConnection.getResponseBodyAsString();
    ...
    protected void internalConnect() throws IOException
    {
        ...
        urlConnection = new PostMethod( url );//(HttpURLConnection)urlObject.openConnection();
//        urlConnection.setDoOutput(true);
    ...
    {
      Header[] headers = urlConnection.getResponseHeaders();
       for (Header header  : headers)
       {
           ...
           for (HeaderElement headerElement : headerElements)
           {
               if (SET_COOKIE.equals(headerName) || COOKIE.equals(headerName)
                   ...
                   processSetCookieHeader(headerElement.getValue());
           }
       }
...
//        outBuffer.close();
        ...
        return processHttpResponse(urlConnection.getResponseBodyAsStream());
    }
    ...
    protected void setHttpRequestHeaders()
    {
        ...
        if (httpRequestHeaders != null)
        {
            for (Map.Entry<String, String> element : httpRequestHeaders.entrySet())
            {
                ...
                urlConnection.setRequestHeader( key, value);
            }
        }
    }
    ...
    protected void setHttpRequestCookieHeader()
    {
        ...
        if (cookieHeaderValue != null)
            urlConnection.setRequestHeader(COOKIE, cookieHeaderValue.toString());
    }
}
