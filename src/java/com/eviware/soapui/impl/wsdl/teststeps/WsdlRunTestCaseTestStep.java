...
public class WsdlRunTestCaseTestStep extends WsdlTestStep
{
	...
	//					properties.put( name, testRunContext.getProperty( name ));
					...
					{
						case CANCELED : result.setStatus( TestStepStatus.CANCELED ); break;
						case FAILED : result.setStatus( TestStepStatus.FAILED ); break;
						case FINISHED : result.setStatus( TestStepStatus.OK ); break;
						default : result.setStatus( TestStepStatus.UNKNOWN ); break;
					}
