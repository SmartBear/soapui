...
public class JdbcAssertionRegistry
{
	private static JdbcAssertionRegistry instance;
	...
	private final static Logger log = Logger.getLogger( JdbcAssertionRegistry.class );

	public JdbcAssertionRegistry()
	{
		addAssertion( new JdbcXmlResponseAssertion.Factory() );
	}
	...
	public static synchronized JdbcAssertionRegistry getInstance()
	{
		if( instance == null )
			instance = new JdbcAssertionRegistry();
