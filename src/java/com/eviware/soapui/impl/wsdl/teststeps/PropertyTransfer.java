...
public class PropertyTransfer implements PropertyChangeNotifier
{
   ...
   protected String[] transferXPathToXml( TestProperty sourceProperty, TestProperty targetProperty, SubmitContext context )
           throws Exception
   {
   ...
   protected String[] transferStringToXml(
           TestProperty sourceProperty, TestProperty targetProperty,
...
//      else
   ...
   protected String transferXPathToString(
           TestProperty sourceProperty, TestProperty targetProperty,
           SubmitContext context
   ) throws Exception
   {
      ...
      if( destNodeType == sourceNodeType )
      {
         ...
         else if( config.getTransferTextContent() && destNodeType == Node.ELEMENT_NODE )
         {
            ...
            if( value == null && sourceNode.getFirstChild() != null )
            {
               ...
               destNode.getParentNode()
                       .replaceChild( destNode.getOwnerDocument().importNode( sourceNode, true ), destNode );
            }
         ...
         {
            destNode = destNode.getParentNode().replaceChild( destNode.getOwnerDocument().importNode( sourceNode, true ),
                    destNode );
