...
public abstract class WsdlMessageAssertion extends AbstractModelItem implements PropertyExpansionContainer, TestAssertion
{
   ...
   /* (non-Javadoc)
	 * @see com.eviware.soapui.impl.wsdl.teststeps.TestAssertion#isAllowMultiple()
	 */
   ...
   public AssertionStatus assertResponse( MessageExchange messageExchange, SubmitContext context)
   {
      ...
      else if( !messageExchange.hasResponse() && requiresResponseContent )
      {
   		...
   		assertionErrors = new com.eviware.soapui.model.testsuite.AssertionError[] 
   	                    { new com.eviware.soapui.model.testsuite.AssertionError("null/empty response") };
      }
      else
      {
	      try
   ...
   public AssertionStatus assertRequest( MessageExchange messageExchange, SubmitContext context)
   {
      ...
      if( !messageExchange.hasRequest( true ) )
      {
      	assertionStatus = AssertionStatus.FAILED;
      	assertionErrors = new com.eviware.soapui.model.testsuite.AssertionError[] 
      	                    { new com.eviware.soapui.model.testsuite.AssertionError("null/empty request") };
      }
      else
      {
	      try
