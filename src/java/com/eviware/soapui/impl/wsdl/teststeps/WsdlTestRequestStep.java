...
public class WsdlTestRequestStep extends WsdlTestStepWithProperties implements OperationTestStep, PropertyChangeListener, PropertyExpansionContainer, Assertable
{
   ...
   public void resolve( ResolveContext context )
   {
      ...
      if( wsdlOperation == null )
      {
         context.addPathToResolve( this, "Missing SOAP Operation in Project", requestStepConfig.getInterface() + "/" +
            requestStepConfig.getOperation(), null );
      }
   }
}
