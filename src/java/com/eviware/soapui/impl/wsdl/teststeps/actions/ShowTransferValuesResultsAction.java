...
public class ShowTransferValuesResultsAction extends AbstractAction
{
	...
	private DesktopPanel buildFrame()
	{
		...
		{
			desktopPanel = new DefaultDesktopPanel( "TestStep Result", 
						"TestStep result for " + result.getTestStep().getName(), buildContent() );
		}
...
//		table.setColumnControlVisible( true );
	...
	private class TransfersTableModel extends AbstractTableModel
	{
		...
		public String getColumnName(int column)
		{
			switch( column )
			{
			case 0 : return "Transfer Name";
			case 1 : return "Transferred Values";
			}
		...
		public Object getValueAt(int rowIndex, int columnIndex)
		{
			switch( columnIndex )
			{
			case 0 : return result.getTransferAt( rowIndex ).getName();
			case 1 : return Arrays.toString( result.getTransferredValuesAt( rowIndex ) );
			}
