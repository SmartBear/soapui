...
public class MockRunnerManagerImpl implements MockRunnerManager
{
	private final static Logger log = 
		Logger.getLogger(MockRunnerManagerImpl.class);

	private static Map<String, MockRunnerManager> managers = 
		new HashMap<String, MockRunnerManager>();
		
	private Map<String, WsdlMockService> mockServices = 
		new HashMap<String, WsdlMockService>();
	...
	public static MockRunnerManager getInstance(TestCase testCase)
	{
		...
		{
			MockRunnerManager manager = new MockRunnerManagerImpl(
					testCase.getTestSuite().getProject());
