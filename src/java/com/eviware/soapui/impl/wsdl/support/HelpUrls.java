...
public interface HelpUrls
{
	...
	public static final String WORKSPACE_HELP_URL = HELP_URL_ROOT + "projects.html";
	...
	public static final String GROOVYSTEPEDITOR_HELP_URL = HELP_URL_ROOT + "functional/groovystep.html#The_Groovy_Script_Editor";
	public static final String PROPERTIESSTEPEDITOR_HELP_URL = HELP_URL_ROOT + "functional/propertiesstep.html#Properties_Editor";
	public static final String TRANSFERSTEPEDITOR_HELP_URL = HELP_URL_ROOT + "functional/propertytransfers.html#The_PropertyTransfer_Editor";
	...
	public static final String STATISTICSGRAPH_HELP_URL = HELP_URL_ROOT + "loadtest/diagrams.html#The_Statistics_Diagram";
	public static final String STATISTICSHISTORYGRAPH_HELP_URL = HELP_URL_ROOT + "loadtest/diagrams.html#The_Statistics_History_Diagram";
	public static final String REQUESTEDITOR_HELP_URL = HELP_URL_ROOT + "requests.html#The_Request_Editor";
	public static final String TESTREQUESTEDITOR_HELP_URL = HELP_URL_ROOT + "functional/testrequests.html#The_TestRequest_Editor";
	...
	public static final String MAX_ERRORS_LOAD_TEST_ASSERTION_HELP_URL = HELP_URL_ROOT + "loadtest/assertions.html#Max_Errors_Assertion";
	public static final String STEP_MAXIMUM_LOAD_TEST_ASSERTION_HELP_URL = HELP_URL_ROOT + "loadtest/assertions.html#Step_Maximum_Assertion";
	public static final String STEP_STATUS_LOAD_TEST_ASSERTION_HELP_URL = HELP_URL_ROOT + "loadtest/assertions.html#Step_Status_Assertion";
	public static final String STEP_TPS_LOAD_TEST_ASSERTION_HELP_URL = HELP_URL_ROOT + "loadtest/assertions.html#Step_TPS_Assertion";
	...
	public static final String CHANGEOPERATION_HELP_URL = HELP_URL_ROOT +"functional/testrequests.html#Change_Operation";
