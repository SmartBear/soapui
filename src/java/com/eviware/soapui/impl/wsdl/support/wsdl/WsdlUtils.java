...
public class WsdlUtils
{
	...
	public static MIMEContent[] getContentParts(Part part, MIMEMultipartRelated multipart)
	{
		...
		if (multipart != null)
		{
			...
			{
				List<MIMEContent> contentParts = WsdlUtils.getExtensiblityElements(parts.get(c).getExtensibilityElements(),
						MIMEContent.class);
	...
	public static String findSoapFaultPartName(SoapVersion soapVersion, BindingOperation bindingOperation, String message)
			throws Exception
	{
	...
	public static String getAnonymous(WsdlOperation wsdlOperation)
	{
		String anonymous = "";
