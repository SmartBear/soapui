...
public class CompressionSupport
{
	...
	// createCompressionInputStream can be used in the future if PipedInputStreams are used
	// for sending compressed data instead of creating compressed byte array first and then sending
