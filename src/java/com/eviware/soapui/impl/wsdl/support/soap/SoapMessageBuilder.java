   ...
   public void createElementForPart(Part part, XmlCursor cursor, SampleXmlUtil xmlGenerator ) throws Exception
   {
      ...
      if( elementName != null )
      {
         ...
         if( wsdlContext.hasSchemaTypes() )
         {
            ...
            else log.error( "Could not find element [" + elementName + "] specified in part [" + part.getName() + "]" );
         }
...
//         cursor.beginElement( new QName( wsdlContext.getWsdlDefinition().getTargetNamespace(), part.getName() ));
         ...
         if( typeName != null && wsdlContext.hasSchemaTypes() )
         {
            ...
            else log.error( "Could not find type [" + typeName + "] specified in part [" + part.getName() + "]" );
         }
   ...
   private void buildRpcRequest(BindingOperation bindingOperation, XmlCursor cursor, SampleXmlUtil xmlGenerator) throws Exception
   {
      ...
      String ns = WsdlUtils.getSoapBodyNamespace( bindingOperation.getBindingInput()
      ...
      if( xmlGenerator.isSoapEnc()  )
         cursor.insertAttributeWithValue( new QName( wsdlContext.getSoapVersion().getEnvelopeNamespace(), "encodingStyle" ), 
