		...
		PropertyExpansionContainer, MutableAttachmentContainer
{
   ...
   /* (non-Javadoc)
	...
	/* (non-Javadoc)
	 * @see com.eviware.soapui.impl.wsdl.AttachmentContainer#getAttachmentsForPart(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.eviware.soapui.impl.wsdl.AttachmentContainer#removeAttachment(com.eviware.soapui.model.iface.Attachment)
	 */
	...
	{
		return new RequestIconAnimator<AbstractHttpRequest<?>>( this );
	}
	...
	public Attachment importAttachment(Attachment attachment)
	{
		...
		else log.error( "Unkown attachment type: " + attachment );
   ...
   public void setStripWhitespaces( boolean stripWhitespaces )
   {
	...
	protected static class RequestIconAnimator<T extends AbstractHttpRequest<?>> extends ModelItemIconAnimator<T> implements SubmitListener
	{
		public RequestIconAnimator( T modelItem )
		{
