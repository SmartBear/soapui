...
public class Schema
{
	 ...
	 * 
	 * @param namespace
	 *           The namespace for the new schema.
	 * @param schemaSystem
	 *           The SchemaSystem in which to place the newly created Schema.
	 */
	 ...
	 * 
	 * @param namespace
	 *           Another namespace to get the prefix for.
	 ...
	 * @param namespace
	 *           The namespace to use the prefix for.
	 */
	 ...
	 * 
	 * @param name
	 *           The name to give the newly created element.
	 ...
	 * 
	 * @param name
	 *           The name to give the newly created attribute.
	 ...
	 * 
	 * @param name
	 *           The name of the particle to get.
