...
public abstract class AbstractRestRepresentationsInspector extends AbstractXmlInspector implements PropertyChangeListener
{
   ...
   protected AbstractRestRepresentationsInspector(
           RestRequest request, String name, String description,
   ...
   public class RepresentationsTableModel extends AbstractTableModel implements PropertyChangeListener
   {
      ...
      public Object getValueAt( int rowIndex, int columnIndex )
      {
         ...
         switch( columnIndex )
         {
            ...
            case 2:
               return representation.getType().equals(RestRepresentation.Type.REQUEST ) ? "n/a" :
                           representation.getStatus().toString();
            case 3:
   ...
   private class AddRepresentationAction extends AbstractAction
   {
      ...
      {
         String type = types.size() == 1 ? types.get( 0 ).toString() :
                 UISupport.prompt( "Specify type of Representation to add", "Add Representation",
                     new StringList( types ).toStringArray());
