...
public class GenerateRestTestSuiteAction extends AbstractSoapUIAction<RestService>
{
   ...
   private void generateSingleTestCase(
           WsdlTestSuite testSuite, RestService service,
           boolean createLoadTest, List<String> resources
   )
   {
   ...
   @AForm( name = "Generate TestSuite", description = "Generates TestSuite with TestCase(s) for all Resources in this Service",
