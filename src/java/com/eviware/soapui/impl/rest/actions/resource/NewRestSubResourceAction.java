...
public class NewRestSubResourceAction extends AbstractSoapUIAction<RestResource>
{
	public static final String SOAPUI_ACTION_ID = "NewRestSubResourceAction"; 
	public static final MessageSupport messages = MessageSupport.getMessages( NewRestSubResourceAction.class );
	private XFormDialog dialog;
	
	public NewRestSubResourceAction()
   {
	...
	public void perform( RestResource resource, Object param )
	{
   	...
   	if( dialog.show() )
   	{
   		resource.addNewResource( dialog.getValue(Form.RESOURCENAME), dialog.getValue(Form.RESOURCEPATH) );
   	}
   }
