...
public class MockEngine
{
   ...
   private class CapturingServletOutputStream extends ServletOutputStream
   {
      ...
      {
         outputStream.close();
//         log.info( "Closing output stream, captured: " + captureOutputStream.toString() );
      }
   }
   ...
   private class CapturingServletInputStream extends ServletInputStream
   {
      ...
      public int readLine( byte[] bytes, int i, int i1 )
              throws IOException
      {
      ...
      {
         inputStream.close();
//         log.info( "Closing input stream, captured: " + captureOutputStream.toString() );
      }
