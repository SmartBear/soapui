...
public class ComponentEnabler implements XFormFieldListener
{
   ...
   /**
    * This should not be called directly from the dialog builders,
    * because <code>field</code> may be a Proxy (on the Eclipse platform).
    * Instead, call <code>addComponentEnablesFor(field, value)</code> on the combo box.
    * @param field
    * @param value
    */
