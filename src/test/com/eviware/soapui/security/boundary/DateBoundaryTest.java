...
public class DateBoundaryTest extends TestCase
{
	 ...
	 {
	 String today = DateBoundary.simpleDateFormat.format(
	 ...
	 {
	 String outOfBoundaryDate = dateBoundary.outOfBoundary(
	 Boundary.MIN_EXCLISIVE );
	 Calendar calendar1 = Calendar.getInstance();
	 Calendar calendar2 = Calendar.getInstance();
	 calendar1.setTime( DateBoundary.simpleDateFormat.parse( outOfBoundaryDate
	 ) );
	 calendar2.setTime( DateBoundary.simpleDateFormat.parse(
	 dateBoundary.minExclusive ) );
	 ...
	 {
	 String outOfBoundaryDate = dateBoundary.outOfBoundary(
	 Boundary.MAX_EXCLISIVE );
	 Calendar calendar1 = Calendar.getInstance();
	 Calendar calendar2 = Calendar.getInstance();
	 calendar1.setTime( DateBoundary.simpleDateFormat.parse( outOfBoundaryDate
	 ) );
	 calendar2.setTime( DateBoundary.simpleDateFormat.parse(
	 dateBoundary.maxExclusive ) );
	 ...
	 {
	 String outOfBoundaryDate = dateBoundary.outOfBoundary(
	 Boundary.MIN_INCLISIVE );
	 Calendar calendar1 = Calendar.getInstance();
	 Calendar calendar2 = Calendar.getInstance();
	 calendar1.setTime( DateBoundary.simpleDateFormat.parse( outOfBoundaryDate
	 ) );
	 calendar2.setTime( DateBoundary.simpleDateFormat.parse(
	 dateBoundary.minInclusive ) );
	 ...
	 {
	 String outOfBoundaryDate = dateBoundary.outOfBoundary(
	 Boundary.MAX_INCLISIVE );
	 Calendar calendar1 = Calendar.getInstance();
	 Calendar calendar2 = Calendar.getInstance();
	 calendar1.setTime( DateBoundary.simpleDateFormat.parse( outOfBoundaryDate
	 ) );
	 calendar2.setTime( DateBoundary.simpleDateFormat.parse(
	 dateBoundary.maxInclusive ) );
